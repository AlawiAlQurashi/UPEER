    ...
    if m.text == "المطورين":
        if sudo2(m):
            try:
                ...
                if lang is None:
                    await m.reply_text(f"◍ [ᯓ𝐘𝐄 ||✘𝐔𝐏𝐏𝐄𝐑 •🇾🇪⇩𓄹](tg://user?id={super_sudoers[0]})\n" +
                                       f"◍ [𝑆𝑂𝑈𝑅𝐶𝐸 𝐽𝐴𝐶𝐾](tg://user?id={super_sudoers[1]})\n" +
                                       f"◍ [{n.first_name}](tg://user?id={sudoers[0]})\n\n"
                                       "لا يوجد مطورين مرفوعين\n√", reply_to_message_id=m.message_id,
                                       parse_mode="Markdown")
                else:
                    t = "\n◍ قائمة المطورين \n≪━━━𝑆𝑂𝑈𝑅𝐶𝐸 𝐽𝐴𝐶𝐾━━━≫\n" + f"◍ [ᯓ𝐘𝐄 ||✘𝐔𝐏𝐏𝐄𝐑 •🇾🇪⇩𓄹](tg://user?id={super_sudoers[0]})\n" + f"◍ [𝑆𝑂𝑈𝑅𝐶𝐸 𝐽𝐴𝐶𝐾](tg://user?id={super_sudoers[1]})\n" + \
                        f"◍ [{n.first_name}](tg://user?id={sudoers[0]})\n\n√"
                    for row in lang:
                        t = t + f"[{row[1]}](tg://user?id={row[0]})\n"
                    await m.reply_text(t, reply_to_message_id=m.message_id, parse_mode="Markdown")
...
########################################################################################################################
    ...
    if m.text == (get_db_botname() or "جاك"):
        texting = ["اؤمر " + (get_db_botname() or "جاك") + " شتريد؟❤️🥺",
                   "اى يقلب " + (get_db_botname() or "جاك") + "❤️",
                   ...
                   "قلبى بينادى على " + (get_db_botname() or "جاك") + "😘",
                   "نعسان محدش يصحينى🙄"
                   ]
        await m.reply_text(random.choice(texting), reply_to_message_id=m.message_id)
        return

    if m.text == "بوت غادر" or m.text == (get_db_botname() or "جاك") + " غادر":
        if secsudo(m):
            try:
...
########################################################################################################################
    ...
    if m.text == "السورس" or m.text == "سورس" or m.text == "يا سورس":
         ...
         await m.reply_text("""
╭──── 『𝑆𝑂𝑈𝑅𝐶𝐸 𝐽𝐴𝐶𝐾』 ────╮
么 [َِᯓ𝐘𝐄 ||✘𝐔𝐏𝐏𝐄𝐑 •🇾🇪⇩𓄹](t.me/UPE3R)
么 [َ𝐀𝐋𝐀𝐖𝐄 𝐀𝐋𝐐𝐔𝐑𝐀𝐄𝐒𝐇𝐄 ≝](t.me/ALAWE1)
么 [َِ🕷️َِ .,ᯓََِِ⸁🇨🇵إمـۦـﹻٰ۫ﹻۧﹻــيــﹻٰ۫ﹻــﹻٰ۫ـࢪ.١ ⌯](t.me/ZR_EL)
么 [ِ𝐘𝐀𝐒𝐈𝐑](t.me/UX_XR)
么 [𝑆𝑂𝑈𝑅𝐶𝐸 𝐽𝐴𝐶𝐾](t.me/AWCODE3)
╰──── 『𝑆𝑂𝑈𝑅𝐶𝐸 𝐽𝐴𝐶𝐾』 ────╯
...
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼
    ...
    if m.text == "ا" or m.text == "ايدي" or m.text == "ايديي" or m.text == "الايدي" or m.text == "أيدي"\
            or m.text == "ايديه":
...
❬ يلا بالسلامات ❭ ❤️😂
    ...
    if m.text == "ياسر" or m.text == "zohary" or m.text == "المطور ياسر " or m.text == "yaser" \
    ...
    if m.text == "mody" or m.text == "امير" or m.text == "الزعيم" or m.text == "امير الزعيم" \
            or m.text == "الهكر امير" or m.text == "المبرمج امير" or m.text == "المطور امير":
        texting = [
            "نعم ي قلب امير🖤 \n @ZR_EL",
            "اؤمرني حبيبي 😂 \n @ZR_EL",
            "ايش فيه يا زلمه؟ \n @ZR_EL",
            "طلباتك اوامر ايش بتريد 🖤 \n @ZR_EL",
            "شبيك لبيك امير بين ايديك 😂 \n @ZR_EL",
            "المطور مشغول الآن 😌 \n @ZR_EL"
        ]
    ...
    if m.text == "shadow" or m.text == "شادو" or m.text == "شاضو" or m.text == "شادو الزعيم" \
        ...
        usr = await c.get_chat(6250435647)
        photo = await c.download_media(usr.photo.big_file_id)     
        await m.reply_photo(photo,caption=random.choice(texting))
        return
    if m.text == "علوش" or m.text == "علوي" or m.text == "علوي" or m.text == "علوي الزعيم" \
            or m.text == "الهكر علوي" or m.text == "المبرمج علوي" or m.text == "المطور علوي":
        texting = [
            "نعم ي قلب علوي🖤 \n@UPE3R",
            "اؤمرني حبيبي 😂 \n@UPE3R",
            "ايش فيه يا زلمه؟ \n@UPE3R",
